...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body bgcolor="#ffffff" scroll = no   onunload="fnMessageUnload('<%=msgType%>')"  >
        <table id="maintable" width="100%" border="0" cellspacing="0" cellpadding="1" height="178px" style="border:solid 1px #1F5285">
            <tr>
                <td  colspan="2" style="font-family:arial;font-size:14px;font-weight:bold;color:black; background: lightgreen"><%=msgTypeText%></td>
            </tr>
            <tr>
                <!--<td width="10%" >
                    <div align="right" vertical-align= "top">
                    <img src="/LuvCricket/images/<%=msgIcon%>" alt="" border="0" /></div>
                </td>-->
                <td colspan="2" >
                    <div align="center" vertical-align= "middle" style="font-family:verdana;font-size:12px;font-weight:bold;color:darkgreen">
